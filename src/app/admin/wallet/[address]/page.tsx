...
export default function WalletDetailPage() {
  ...
  const walletAddress = Array.isArray(params.address)
    ? params.address[0]
    : (params.address ?? "");
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      ...
      try {
        ...
        setEthBalance(assetsData.ethBalance ?? "0.000000");
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-start justify-between mb-10 flex-wrap gap-4">
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-extrabold text-white font-mono break-all">
